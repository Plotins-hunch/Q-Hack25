    ...
    <div class="chat-panel" :class="{'is-open': isOpen}">
        ...
        <div class="chat-messages" ref="messagesContainer">
            ...
            >
                ...
                <div v-if="message.isUser" class="message-avatar user">
        ...
        <div class="chat-input">
            <input
                ...
                placeholder="Ask about your unicorn data..."
                :disabled="isLoading"
            />
            <button
                class="send-button"
...
const messages = ref([
    {
        isUser: false,
        text: "Hello! I'm your unicorn data assistant. How can I help you understand your business metrics today?",
    },
])
